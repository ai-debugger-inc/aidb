...
export const SUGGESTED_THRESHOLD = parseFloat(
...
// Debug mode toggle
// Controlled by AIDB_DEBUG_SKILLS=1 environment variable
export const DEBUG_ENABLED = process.env.AIDB_DEBUG_SKILLS === "1";
