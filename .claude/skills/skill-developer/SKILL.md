...
description: Create and manage Claude Code skills following Anthropic best practices.
  ...
  disclosure. Covers skill structure, YAML frontmatter, trigger types (AI-powered
  intent analysis, keyword matching), enforcement levels (validation only), hook mechanisms
  (UserPromptSubmit with auto-injection), session tracking, and the 500-line rule.
---
